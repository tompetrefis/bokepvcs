...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepvcs.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'Tb7NeRjFu6wTWt8vYXeHfMDgkJgB518qjSqeN7Ce4-k',
        yandex: '50e4ef33e3c5c9b4',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepvcs.pages.dev/?q={search_term}", 
